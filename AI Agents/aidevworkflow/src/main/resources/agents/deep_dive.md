...
existing codebase. Surface architectural gaps, edge cases, and implementation strategies
...
3. Analyse core technical challenges and non-functional requirements (performance,
...
7. List third-party libraries or services that would accelerate development.
